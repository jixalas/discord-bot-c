...
int test()
{
	...
	// Connection info
	char inputURL[300] = "wss://gateway.discord.gg/?v=6&encoding=json";
	int inputPort = 443;
  ...
  ctxCreationInfo.fd_limit_per_thread = 1 + 1 + 1;
         ...
         */
        ctxCreationInfo.client_ssl_ca_filepath = "./libwebsockets.org.cer";
#endif
  ...
  clientConnectInfo.ssl_connection = (1 << 0);
	...
	clientConnectInfo.parent_wsi = wsiTest; // The created client should be fed inside the wsi_test variable
